...
//                if(fragment_people == null){
//                    fTransaction.add(R.id.container,fragment_people);
//                }else{
//                    fTransaction.show(fragment_people);
//                }
...
//                if(fragment_voice == null){
//                    fTransaction.add(R.id.container,fragment_voice);
//                }else{
//                    fTransaction.show(fragment_voice);
//                }

                Intent intent_voice = new Intent(MainActivity.this,VoiceActivity.class);
...
//                if(fragment_location == null){
//                    fTransaction.add(R.id.container,fragment_location);
//                }else{
//                    fTransaction.show(fragment_location);
//                }
...
//                if(fragment_text == null){
//                    fTransaction.add(R.id.container,fragment_text);
//                }else{
//                    fTransaction.show(fragment_text);
//                }
